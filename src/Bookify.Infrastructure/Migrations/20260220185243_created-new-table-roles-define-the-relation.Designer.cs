...
namespace Bookify.Infrastructure.Migrations
{
    ...
    [Migration("20260220185243_created-new-table-roles-define-the-relation")]
    partial class creatednewtablerolesdefinetherelation
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Bookify.Domain.Apartements.Apartement", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Bookify.Domain.Apartements.Apartement", b =>
                {
                    b.OwnsOne("Bookify.Domain.Apartements.Address", "Address", b1 =>
                        {
                            b1.Property<Guid>("ApartementId")
                                .HasColumnType("uuid")
                                .HasColumnName("id");
                    ...
                    b.OwnsOne("Bookify.Domain.Apartements.Money", "CleaningFee", b1 =>
                        {
                            b1.Property<Guid>("ApartementId")
                                .HasColumnType("uuid")
                                .HasColumnName("id");
                    ...
                    b.OwnsOne("Bookify.Domain.Apartements.Money", "Price", b1 =>
                        {
                            b1.Property<Guid>("ApartementId")
                                .HasColumnType("uuid")
                                .HasColumnName("id");
            ...
            modelBuilder.Entity("Bookify.Domain.Bookings.Booking", b =>
                {
                    b.HasOne("Bookify.Domain.Apartements.Apartement", null)
                        .WithMany()
                    ...
                    b.OwnsOne("Bookify.Domain.Apartements.Money", "AmenitiesUpCharge", b1 =>
                        {
                    ...
                    b.OwnsOne("Bookify.Domain.Apartements.Money", "PriceForPeriod", b1 =>
                        {
                            b1.Property<Guid>("BookingId")
                                .HasColumnType("uuid")
                                .HasColumnName("id");
                    ...
                    b.OwnsOne("Bookify.Domain.Apartements.Money", "TotalPrice", b1 =>
                        {
                            b1.Property<Guid>("BookingId")
                                .HasColumnType("uuid")
                                .HasColumnName("id");
